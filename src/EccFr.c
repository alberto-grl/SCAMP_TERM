...
#define My_gets_N (1024 )

uint8_t *My_gets(uint8_t * str) {
  ...
  for (i=0;i<100;i++)
    {
      ...
      word1 &= 0x0FFFFFF;  //AG should be truncated to 24 bit or the comparison will always fail
